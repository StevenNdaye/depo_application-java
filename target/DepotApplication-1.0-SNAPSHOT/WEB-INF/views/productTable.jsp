...
<div class="form-group">
    <form:label path="title" class="col-xs-2 control-label pull-left"><spring:message code="label.title"/></form:label>
    <div class="col-xs-10">
...
<div class="form-group">
    <form:label path="description" class="col-xs-2 control-label pull-left">
...
<div class="form-group">
    <form:label path="imageUrl" class="col-xs-2 control-label pull-left">
...
<div class="form-group">
    <form:label path="price" class="col-xs-2 control-label pull-left">
